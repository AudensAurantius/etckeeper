...
##### generated via: (/usr/bin/perl v5>36.0)
#####		/usr/share/sendmail/update_tlsm4
#####		version: 8.17.1.9 2024-06-16 21:07:57 cowboy
##### by: root@Blade16-MHaynes
##### on: Wed Mar 11 13:45:00 2026
##### in: /
...
####################################################################
divert(0)dnl
VERSIONID(`$Id: starttls.m4,v 8.17.1.9-2+deb12u2 2024-06-16 21:07:57 cowboy Exp $')
dnl #
dnl #---------------------------------------------------------------------
