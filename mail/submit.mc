divert(-1)dnl
#-----------------------------------------------------------------------------
# $Sendmail: submit.mc,v 8.17.1.9 2024-06-16 21:07:57 cowboy Exp $
#
# Copyright (c) 2000-2010 Richard Nelson.  All Rights Reserved.
#
# cf/debian/submit.mc.  Generated from submit.mc.in by configure.
#
# submit.mc prototype config file for building Sendmail 8.17.1.9
#
...
VERSIONID(`$Id: submit.mc, v 8.17.1.9-2+deb12u2 2024-06-16 21:07:57 cowboy Exp $')
OSTYPE(`debian')dnl
